var teamMembers = [
	...
	{
		name: 'Nick O\'Flaherty',
		photo: 'img/team/nicko.jpg',
		post: 'Senior Consultant',
		linkedin: 'https://www.linkedin.com/in/nick-o-flaherty-b977885/',
		bio: '<p><strong>Nick O\'Flaherty</strong> is a Senior Consultant at Entangled Solutions. He brings over 18 years of strategy, innovation and brand consulting experience in the education, tech and cultural sectors. Nick is passionate about applying his diverse experience to build student-centered solutions and help redesign systems to improve educational and economic outcomes for a socially just future.</p><p>Nick’s previous clients include Lumina Foundation, Microsoft, The Met, Grantmakers for Education and eBay. He also acts as an advisor to RepresentEd, a nonprofit piloting at UC Berkeley helping underrepresented students thrive and lead in college and beyond. Nick has a MSc International Marketing from the University of Strathclyde, Scotland and a B.Comm from the University of Kwa-Zulu Natal, South Africa.</p>'
	},
	{
